...
My portfolio website simulating macOS's GUI: https://github.com/StarsUnsurpass
...
- **Update 2021.12.05**: Refactored for cleaner code by utilizing functional components and hooks. Refer to [this branch](https://github.com/StarsUnsurpass) for the previous version implemented with class components.
...
- [sindresorhus/file-icon-cli](https://github.com/StarsUnsurpass)
- [vivek9patel.github.io](https://github.com/StarsUnsurpass)
